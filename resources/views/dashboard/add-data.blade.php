            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="col-md-15 grid-margin stretch-card">
                        <div class="card">
                          <div class="card-body">
                            <h4 class="card-title" style="text-align: left">Catat Perjalanan mu</h4><br>
                           @if(session()->has('sukses-addcatatan'))
                           <h5 style="color:green; text-align: left">Catatan Perjalanan Baru Sukses Ditambahkan!</h5>
                           @endif
                            <form action="/user/dashboard/add-data" method="POST">
                                @csrf
                              <div class="form-group">
                                <label style="float: left"><i class="fa fa-calendar" aria-hidden="true"></i> Tanggal : </label>
                                <input type="date" name="tanggal_masuk" style="margin-right:100%" required>
                              </div><br>
                              <div class="form-group">
                                <label style="float: left"><i class="fa fa-clock" aria-hidden="true"></i> Jam Masuk : </label>
                                <input type="time" name="jam_masuk" style="margin-right:100%" required>
                              </div><br>
                              <div class="form-group">
                                <label style="float: left"><i class="fa fa-clock" aria-hidden="true"></i> Jam Keluar : </label>
                                <input type="time" name="jam_keluar" style="margin-right:100%" required>
                              </div><br>
                              <div class="form-group">
                                <label for="lokasi" style="float: left"><i class="fa fa-map-marker" aria-hidden="true"></i> Tempat / Lokasi</label>
                                <input type="text" class="form-control" id="lokasi" placeholder="Tempat / Lokasi Yang Dikunjungi" name="lokasi" required>
                              </div><br>
                              <div class="form-group">
                                <label for="suhu" style="float: left"><i class="fa fa-thermometer-full" aria-hidden="true"></i> Suhu</label>
                                <input type="text" class="form-control" id="suhu" placeholder="Suhu Tubuh" name="suhu" required>
                              </div><br>
                              <button type="submit" class="btn btn-primary mr-2">Submit</button>
                            </form>
                            <br><a href="/user/dashboard"><button type="submit" class="btn btn-success mr-2">Lihat Catatan</button></a>
                          </div>
                        </div>
                      </div>
                </div>
